...
def render_exercise(ex, selected_key, selected_category):
    ...
    st.markdown('<div class="exercise-layout">', unsafe_allow_html=True)
    ...
    with col2:
        is_python_mcq = selected_category in ["Python (Core)", "python_core"] and ex.get("mcq_questions")
        run_clicked = False
