...
modules = get_exercise_modules("real_world_scenarios")
...
def test_real_world_python_exercises(exercise_key, test_name, test_data):
...
def test_real_world_sql_exercises(exercise_key, test_name, test_data):
