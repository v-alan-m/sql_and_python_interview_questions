...
""",
                ...
                "solution_code": """\
result = \"\"\"Correct Answer: By "pass-by-assignment," where the function gets a copy of the reference to the object.
...
* **Reassignment:** If you completely reassign the parameter inside the function, it simply breaks the local reference to the original object and binds the local name to a new object. It does *not* affect the caller's variable.\"\"\"""",
                "expected_output": """Correct Answer: By "pass-by-assignment," where the function gets a copy of the reference to the object.
